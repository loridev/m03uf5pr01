 ...
 */
    ...
    public boolean copDePuny(Animal objectiu) {
        float divisorPuny = 1;
        ...
        return this.atacar((this.atac * this.multiplicadorPuny) / divisorPuny, objectiu);
    }

    public boolean patada(Animal objectiu) {
        float multiplicador = 1;

        if (this.tipus == TipusAnimal.XIMPANZE) {
            multiplicador = 1.5f;
        }
        return this.atacar(this.atac * multiplicador, objectiu);
    }
